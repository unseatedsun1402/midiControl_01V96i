...
chanFad = [0x7F,0x01,0x1C,0x00]

inputFader = {'01v96i':[0x7F,0x01,0x1C,0x00],
              'm7cl':[0x11,0x01,0x00,0x32,0x00,0x00]}

auxFader = {'01v96i':[0x7F,0x01,0x23,0x02],
            'm7cl':[0x11,0x01,0x00,0x42,0x00,0x05]}

chanAtt = [0x7F,0x01,0x1D,0x00]
chanselect = [0x1A,0x04,0x09,0x18]
